...
public record ProductPricePointId
{
    ...
    private ProductPricePointId(Optional<string> stringValue, Optional<int> intValue)
    {
    ...
    public static ProductPricePointId Int(int value) => new(default, Optional<int>.Some(value));
    ...
    public static implicit operator ProductPricePointId(int value) => Int(value);
}
...
file sealed class ProductPricePointIdConverter : JsonConverter<ProductPricePointId>
{
        ...
        JsonSerializerOptions options)
    {
        ...
        {
            return ProductPricePointId.Int(intValue);
        }
